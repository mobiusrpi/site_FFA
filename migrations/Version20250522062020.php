 ...
 */
final class Version20250522062020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE competitions_users (competition_id INT NOT NULL, user_id INT NOT NULL, tilted VARCHAR(30) DEFAULT NULL, INDEX IDX_F9E5DA4E7B39D312 (competition_id), INDEX IDX_F9E5DA4EA76ED395 (user_id), PRIMARY KEY(competition_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
